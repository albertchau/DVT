...
import com.intuit.idea.ziplock.core.services.strategies.comparers.CountComparer;
import com.intuit.idea.ziplock.core.services.strategies.comparers.DefaultComparer;
import com.intuit.idea.ziplock.core.services.strategies.comparers.MetadataComparer;
import com.intuit.idea.ziplock.core.services.strategies.extractors.CountExtractor;
import com.intuit.idea.ziplock.core.services.strategies.extractors.DefaultExtractor;
import com.intuit.idea.ziplock.core.services.strategies.extractors.ExistenceExtractor;
import com.intuit.idea.ziplock.core.services.strategies.extractors.MetadataExtractor;
import com.intuit.idea.ziplock.core.services.strategies.loaders.DefaultLoader;
import com.intuit.idea.ziplock.core.services.strategies.loaders.MetadataLoader;
...
import static com.intuit.idea.ziplock.core.services.ComparisonType.*;
