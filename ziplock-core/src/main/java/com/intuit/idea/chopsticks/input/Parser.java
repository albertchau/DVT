...
//        DataStoreType type;
//        try {
//            type = DataStoreType.valueOf(dataStoreConfig.getString("getType").toUpperCase());
//        } catch (IllegalArgumentException e) {
//            logger.error("Invalid getType for your " + selector + " data store. Please choose from: " + Arrays.toString(DataStoreType.values()));
//            throw e;
//        } catch (ConfigException.Missing e) {
//            logger.error("Your " + selector + " needs a getType. Currently empty");
//            throw e;
//        }
//
