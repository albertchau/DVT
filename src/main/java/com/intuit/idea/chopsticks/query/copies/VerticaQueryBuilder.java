...
/**
 * Generates a Vertica query given proper input builder parameters
 */
public class VerticaQueryBuilder extends QueryBuilder {

    private VerticaQueryBuilder(Builder<?> builder) throws Exception {
        super(builder);
    }
    ...
    public static abstract class Builder<T extends Builder<T>> extends QueryBuilder.Builder<T> {
        ...
        public VerticaQueryBuilder build() throws Exception {
            return new VerticaQueryBuilder(this);
        }

        public String getQuery() throws Exception {
            VerticaQueryBuilder query = new VerticaQueryBuilder(this);
