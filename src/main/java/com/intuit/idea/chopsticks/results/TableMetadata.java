 ...
 * ************************************
 */
public class TableMetadata implements ResultSetMetaData {
     ...
     */
    public TableMetadata(String tableName, String[] columnNames,
    ...
    public TableMetadata(String tableName, List<String> columnNames,
                         List<String> columnLabels, List<String> columnTypes,
                         int[] columnDisplaySizes) {
        this.tableName = tableName;
        this.columnNames = columnNames.toArray(new String[columnNames.size()]);
        this.columnLabels = columnLabels.toArray(new String[columnLabels.size()]);
